...
namespace Viva
{
    ...
    public class Horse : Mechanism
    {
        ...
        private SkyDefinition.PeriodCallback sleepPeriodCallback;
        ...
        private void MountDriver(Player newDriver)
        {
            ...
            driver.rightHandState.selfItem.SetFlag(Item.ItemFlags.DO_NOT_LOOK_AT, true);
            driver.leftHandState.selfItem.SetFlag(Item.ItemFlags.DO_NOT_LOOK_AT, true);
        ...
        private void DismountDriver()
        {
            ...
            driver.rightHandState.selfItem.SetFlag(Item.ItemFlags.DO_NOT_LOOK_AT, false);
            driver.leftHandState.selfItem.SetFlag(Item.ItemFlags.DO_NOT_LOOK_AT, false);
        ...
        public override void OnMechanismAwake()
        {
            ...
            sleepPeriodCallback = new SkyDefinition.PeriodCallback(Sleep, 6.0f);
            GameDirector.newSkyDirector.skyDefinition.AddPeriodCallback(sleepPeriodCallback);
        }

        public override void OnMechanismDestroy()
        {
            GameDirector.newSkyDirector.skyDefinition.RemovePeriodCallback(sleepPeriodCallback);
        }
