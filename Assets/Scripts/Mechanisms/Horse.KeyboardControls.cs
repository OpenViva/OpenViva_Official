...
namespace Viva
{
    ...
    public class HorseKeyboardControls : HorseControls
    {
        ...
        public override void OnEnter(Player player)
        {
            ...
            GameDirector.inputManager.actions.Keyboard.w.performed += ctx => OnInputHorseGear(1);
            GameDirector.inputManager.actions.Keyboard.s.performed += ctx => OnInputHorseGear(-1);
            GameDirector.inputManager.actions.Keyboard.a.performed += ctx => OnInputHorseDirection(-1);
            GameDirector.inputManager.actions.Keyboard.a.canceled += ctx => OnInputHorseDirection(0);
            GameDirector.inputManager.actions.Keyboard.d.performed += ctx => OnInputHorseDirection(1);
            GameDirector.inputManager.actions.Keyboard.d.canceled += ctx => OnInputHorseDirection(0);
        }
