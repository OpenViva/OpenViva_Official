...
namespace Viva
{
    ...
    public partial class ModelCustomizer : UITabMenu
    {
        ...
        private IEnumerator HandlePreviewVivaModel(string name)
        {
            ...
            LoadCompanionFromCardRequest cardRequest = new(name, modelDefault);
        ...
        public IEnumerator LoadVivaModelCard(LoadCompanionFromCardRequest cardRequest)
        {
            ...
            CardBrowser.LoadCardTextureRequest cardDataRequest = new(cardRequest.filename);
            ...
            Steganography.UnpackLosslessDataRequest modelCardDataRequest = new(cardDataRequest.result, true);
            ...
            CardBrowser.LoadCardTextureRequest skinRequest = new(cardDataRequest.result.name);
            ...
            Steganography.UnpackLosslessDataRequest skinDataRequest = new(skinRequest.result, false);
            ...
            CardTextureSerializer serializer = new(VivaModel.skinFormat);
            ...
            VivaModel.CreateCompanionRequest createCompanionRequest = new(cardRequest.filename, cardRequest.target, modelCardDataRequest.result, mbs);
