...
namespace Viva
{
    ...
    public partial class Companion : Character
    {
        ...
        public static Dictionary<int, LocomotionInfo> legSpeedInfos = new();
        public static List<int> holdAnimationStates = new();
        ...
        public static void GenerateAnimations()
        {
            ...
            Companion.TransitionToIdle idleTransition = new();
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_TEST_WATER_IN_COLD_RIGHT,
                ...
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.STARTLE_SHORT, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_TEST_WATER_LUKEWARM_RIGHT,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 1.0f, 0.5f, 0, 0.5f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_TEST_WATER_IN_HOT_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.SCREAMING, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_POINT_OUT_IN_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.4f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.HUMPH, 0.0f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_POINT_OUT_SOUND_2_3_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.GET_OUT_2_3, 1.0f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_RELAX_TO_HAPPY_IDLE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                new( 0.4f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_KERPLUNK } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f,0.5f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f,1.0f, 0.5f } ),
                }
            ));
            RegisterAnimation(Companion.Animation.BATHTUB_RELAX_TO_ANGRY_IDLE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_SHORT, 1.0f } ),
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                new( 0.4f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_KERPLUNK } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f,0.5f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f,1.0f, 0.5f } ),
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_HAPPY_IDLE2,
                ...
                new CompanionAnimationEvent[]{
                new( 0.41f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f,0.25f } ),
                new( 0.55f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f,0.25f } ),
                new( 0.9f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f,1.0f, 0.5f } ),
                new( 0.9f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f,0.5f } ),
                }
            ));
            RegisterAnimation(Companion.Animation.BATHTUB_HAPPY_SWITCH_SIDES,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f,0.5f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f,1.0f, 0.5f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_SINK_ANGRY,
                ...
                new CompanionAnimationEvent[]{
                new( 0.06f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                }
            ));
            RegisterAnimation(Companion.Animation.BATHTUB_HAPPY_IDLE3,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                new( 0.27f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 1.0f } ),
                new( 0.82f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f,0.5f } ),
                new( 0.82f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f,1.0f, 0.5f } ),
                new( 0.84f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_POINT_OUT_ANTSY_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.07f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_GRUMBLE_LONG, 1.0f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_HAPPY_IDLE4,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                new( 0.15f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_KERPLUNK } ),
                new( 0.82f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f,0.5f } ),
                new( 0.82f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f,1.0f, 0.5f } ),
                new( 0.27f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                new( 0.5f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.RELIEF, 1.0f } ),
                }
            ));
            RegisterAnimation(Companion.Animation.BATHTUB_WAVE_HAPPY_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                new( 0.11f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                new( 0.125f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.GIGGLE, 1.0f } ),
                new( 0.69f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                }
            ));
            RegisterAnimation(Companion.Animation.BATHTUB_RELAX_HUMMING,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.HUMMING, 1.0f } ),
                }
            ));
            RegisterAnimation(Companion.Animation.BATHTUB_HAPPY_IDLE_TO_ON_KNEES,
                ...
                new CompanionAnimationEvent[]{
                new( 0.4f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 1.0f } ),
                new( 0.6f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 0.9f, 0.5f } ),
                new( 0.6f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.5f } ),
                }
            ));
            RegisterAnimation(Companion.Animation.BATHTUB_ON_KNEES_TO_HAPPY_IDLE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                new( 0.5f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 1.0f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f,0.5f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f,0.7f, 0.6f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_ON_KNEES_TO_TOWEL_IDLE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                new( 0.6f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.7f, 0.5f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_TOWEL_EMBARRASSED_TO_BATHTUB_IDLE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.SCREAMING, 1.0f } ),
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                new( 0.7f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_KERPLUNK } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HAPPY_BEG_START,
                ...
                new CompanionAnimationEvent[]{
                new( 0.000f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.IMPRESSED, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HAPPY_BEG_LOCOMOTION,
                ...
                new CompanionAnimationEvent[]{
                new( 0.141f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.6f } ),
                new( 0.185f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.5f } ),
                new( 0.280f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.7f } ),
                new( 0.280f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.7f } ),
                new( 0.361f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 0.6f } ),
                new( 0.361f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.6f } ),
                new( 0.400f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.6f } ),
                new( 0.400f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.6f } ),
                new( 0.551f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 0.6f } ),
                new( 0.551f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.6f } ),
                new( 0.811f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.7f } ),
                new( 0.811f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.5f } ),
                new( 0.890f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 1.0f } ),
                new( 0.890f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),

                new( 0.000f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.WHINE_SOFT, 1.0f } ),
                new( 0.356f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.WHINE, 1.0f } ),
                new( 0.800f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.WHINE_SOFT, 1.0f } ),
                new( 0.0f, (int)Companion.AnimationEventName.FOOTSTEP_SOUND, new float[] { 0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.FOOTSTEP_SOUND, new float[] { 1f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HAPPY_IDLE2,
                ...
                new( 0.0f, (int)Companion.AnimationEventName.FOOTSTEP_SOUND, new float[] { 0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.FOOTSTEP_SOUND, new float[] { 1f } ),
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.THINKING_LONG, 0.0f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.THINKING_SHORT, 0.0f } ),
                },
                AnimationInfo.Flag.IDLE_STATE
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_CONFUSED,
                ...
                0.3f, new Companion.AnimLogicInfo(1, 0.6f, 0.3f, 12, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.CONFUSED, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HAPPY_SOCIAL1,
                ...
                0.3f, new Companion.AnimLogicInfo(1, 0.6f, 0.3f, 12, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.4f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                },
                AnimationInfo.Flag.IDLE_STATE
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_AGREE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.GIGGLE, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_REFUSE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.REFUSE, 0.0f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 1.1f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_TIRED_REFUSE,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 1.0f, 0.65f, 12, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.SLEEP_DISTURBED_SHORT, 0.0f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.5f, 0.7f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_STRETCH,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.SLEEP_DISTURBED_SHORT, 0.0f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.5f, 0.5f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                },
                AnimationInfo.Flag.IDLE_STATE
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_POSE_PEACE_IN,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.PEACE, 0.0f } ),
                },
            ...
            RegisterAnimation(Companion.Animation.STAND_HAPPY_TAKE_PHOTO_OUT_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{(float)Companion.VoiceLine.THINKING_SHORT,0.0f} ),
                },
            ...
            RegisterAnimation(Companion.Animation.STAND_CATTAIL_IDLE1_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.000f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.HUMMING, 1.0f } ),
                new( 0.272f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.CONFUSED, 1.0f } ),
                new( 0.606f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.TROUBLED, 1.0f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_CATTAIL_SWING_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.05f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EFFORT_ANGRY, 0.0f } ),
                new( 0.45f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EFFORT_ANGRY, 0.0f } ),
                new( 0.349f, (int)Companion.AnimationEventName.ATTEMPT_CATTAIL_HIT, null ),
                new( 0.651f, (int)Companion.AnimationEventName.ATTEMPT_CATTAIL_HIT, null ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_HYPE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.HEADPAT_HAPPY, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_CHOPSTICKS_WORRIED,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.WORRY, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_CHOPSTICKS_NEUTRAL,
                ...
                new CompanionAnimationEvent[]{
                new( 0.05f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.THINKING_LONG, 0.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.THINKING_LONG, 0.0f } ),
                new( 0.75f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 0.6f } ),
                new( 0.75f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.6f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_CHOPSTICKS_CONFIDENT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.CONFIDENT, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_CHOPSTICKS_LOSE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.LOSE, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_CHOPSTICKS_WIN,
                ...
                0.2f, new Companion.AnimLogicInfo(0, 1.0f, 0.5f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.WIN, 0.0f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 0.8f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.3f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_CHOPSTICKS_REDISTRIBUTE,
                ...
                0.2f, null,
                new CompanionAnimationEvent[]{
                new( 0.35f, (int)Companion.AnimationEventName.REDISTRIBUTE_CHOPSTICKS_FINGERS, null ),
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HAPPY_DISAPPOINTMENT,    //todo: separate animation?
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.DISAPPOINTED_STARTLE, 0.0f } ),
                new( 0.3f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.DISAPPOINTED_SIGH, 0.0f } ),
                new( 0.3f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.8f } ),
                new( 0.3f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.3f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.8f } ),
                new( 0.9f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.3f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_REACH_OUT_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.554f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.4f } ),
                new( 0.554f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.6f } ),
                new( 0.679f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.4f } ),
                new( 0.679f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.6f, 0.6f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_TO_HORSEBACK_IDLE_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.2f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EFFORT, 0.0f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.9f, 0.5f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.4f } ),
                new( 0.9f, (int)Companion.AnimationEventName.BEGIN_MOUNT, null )
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.HORSEBACK_HARD_STOP,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.SCARED_SHORT, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.HORSEBACK_JOY,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ECSTATIC, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.HORSEBACK_TO_STAND,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 0.9f, 0.4f, 12, 0.1f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.STOP_SPINE_ANCHOR, null ),
                new( 0.0f, (int)Companion.AnimationEventName.DISABLE_STAND_ON_GROUND, null ),
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_ANGRY_THROW_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.400f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EFFORT, 0.0f } ),
                new( 0.483f, (int)Companion.AnimationEventName.THROW_RIGHT_HAND_OBJECT, null ),
                },
                AnimationInfo.Flag.DISABLE_HOLDIK_RIGHT
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_HAPPY_SMELL_ITEM_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.200f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.DONUT_SMELL_A, 1.0f } ),
                new( 0.573f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.DONUT_SMELL_B, 1.0f } ),
                new( 0.927f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.6f } ),
                new( 0.927f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                },
                AnimationInfo.Flag.DISABLE_HOLDIK_RIGHT
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_HAPPY_EAT_ITEM_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.080f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EAT, 1.0f } ),
                new( 0.129f, (int)Companion.AnimationEventName.EAT_CURRENT_INTEREST, null ),
                new( 0.800f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 1.0f } ),
                new( 0.818f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.7f } ),
                },
                AnimationInfo.Flag.DISABLE_HOLDIK_RIGHT
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_HAPPY_DONUT_LAST_BITE_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.080f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EAT, 1.0f } ),
                new( 0.127f, (int)Companion.AnimationEventName.EAT_CURRENT_INTEREST, null )
                },
                AnimationInfo.Flag.DISABLE_HOLDIK_RIGHT
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_SHINOBU_YUMMY,
                ...
                0.4f, new Companion.AnimLogicInfo(0, 1.0f, 0.5f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.080f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.YUMMY, 1.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_WEAR_SUNHAT_RIGHT,
                ...
                0.35f, new Companion.AnimLogicInfo(0, 1.0f, 0.5f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.10f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 1.0f } ),
                new( 0.6f, (int)Companion.AnimationEventName.WEAR_HAT_RIGHT_HAND, null ),
                },
                AnimationInfo.Flag.DISABLE_HOLDIK_RIGHT
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_POLAROID_FRAME_REACT_IN_RIGHT,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 1.0f, 0.55f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.000f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.THINKING_SHORT, 0.0f } ),
                },
                AnimationInfo.Flag.DISABLE_HOLDIK_RIGHT
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_POLAROID_FRAME_REACT_NORMAL_RIGHT,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 1.0f, 0.55f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.250f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.THINKING_LONG, 1.0f } ),
                new( 0.850f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 1.0f } ),
                new( 0.850f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 1.0f } ),
                },
                AnimationInfo.Flag.DISABLE_HOLDIK_RIGHT
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_POLAROID_FRAME_REACT_PANTY_RIGHT,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 1.0f, 0.55f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.000f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.SCARED_SHORT, 0.0f } ),
                new( 0.400f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_GRUMBLE_LONG, 1.0f } ),
                new( 0.500f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 0.4f } ),
                new( 0.500f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                },
                AnimationInfo.Flag.DISABLE_HOLDIK_RIGHT
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_POLAROID_FRAME_REACT_RIP,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 1.0f, 0.55f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.000f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.RIP, 1.0f } ),
                new( 0.167f, (int)Companion.AnimationEventName.SPAWN_POLAROID_FRAME_RIPPED_FX, null ),
                new( 0.283f, (int)Companion.AnimationEventName.SPAWN_POLAROID_FRAME_RIPPED_FX, null ),
                new( 0.400f, (int)Companion.AnimationEventName.SPAWN_POLAROID_FRAME_RIPPED_FX, null ),
                new( 0.500f, (int)Companion.AnimationEventName.SPAWN_POLAROID_FRAME_RIPPED_FX, null ),
                new( 0.700f, (int)Companion.AnimationEventName.SPAWN_POLAROID_FRAME_RIPPED_FX, null ),
                new( 0.800f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 1.1f } ),
                new( 0.800f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 1.0f } ),
                },
                AnimationInfo.Flag.DISABLE_HOLDIK_BOTH
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_WEAR_BAG_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.000f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 1.0f } ),
                new( 0.675f, (int)Companion.AnimationEventName.ATTACH_BAG_SHOULDER, null ),
                new( 0.800f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.5f } ),
                new( 0.800f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.5f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_REMOVE_BAG_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.000f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 1.0f } ),
                new( 0.410f, (int)Companion.AnimationEventName.REMOVE_BAG_SHOULDER, null ),
                new( 0.800f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.5f } ),
                new( 0.800f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.5f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_BAG_PUT_IN_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.000f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 1.0f } ),
                new( 0.3f, (int)Companion.AnimationEventName.OPEN_BAG_RIGHT, null ),
                new( 0.700f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.5f } ),
                new( 0.700f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.5f } ),
                new( 0.55f, (int)Companion.AnimationEventName.PUT_ITEM_IN_BAG_RIGHT, null ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_ANGRY_TIP_TOE_REACH,
                ...
                new CompanionAnimationEvent[]{
                new( 0.05f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_LONG, 1.0f } ),
                new( 0.100f, (int)Companion.AnimationEventName.TOGGLE_FACE_YAW_SUM_FOR_ANIMATION, null ),
                new( 0.220f, (int)Companion.AnimationEventName.TOGGLE_FACE_YAW_SUM_FOR_ANIMATION, null ),
                new( 0.312f, (int)Companion.AnimationEventName.TOGGLE_FACE_YAW_SUM_FOR_ANIMATION, null ),
                new( 0.532f, (int)Companion.AnimationEventName.TOGGLE_FACE_YAW_SUM_FOR_ANIMATION, null ),
                new( 0.578f, (int)Companion.AnimationEventName.TOGGLE_FACE_YAW_SUM_FOR_ANIMATION, null ),
                new( 0.716f, (int)Companion.AnimationEventName.TOGGLE_FACE_YAW_SUM_FOR_ANIMATION, null ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_ANGRY_JEALOUS_STEAL_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.200f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EFFORT_ANGRY, 0.0f } ),
				// new CompanionAnimationEvent( 0.460f, (int)Companion.AnimationEventName.STEAL_CURRENT_INTEREST, null ),
				new( 0.460f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.8f, 0.5f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_ANGRY_JEALOUS,
                ...
                new CompanionAnimationEvent[]{
                new( 0.062f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.DISAPPOINTED_STARTLE, 0.0f } ),
                new( 0.175f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.4f } ),
                new( 0.200f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.4f } ),
                new( 0.325f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_POUT, 0.0f } ),
                new( 0.830f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.4f } ),
                new( 0.830f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.CRAWL_TIRED_TO_STAND,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 1.0f, 0.3f, 12, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{(float)Companion.VoiceLine.MISC_IDLE,0.1f} ),
                },
            ...
            RegisterAnimation(Companion.Animation.STAND_TIRED_TO_BED_CRAWL_TIRED,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{(float)Companion.VoiceLine.MISC_IDLE,0.0f} ),
                new( 0.7f, (int)Companion.AnimationEventName.JUMP_ON_BED, null )
                },
                AnimationInfo.Flag.DISABLE_RAGDOLL_CHECK
            ));
            ...
            RegisterAnimation(Companion.Animation.CRAWL_TIRED_TO_LAY_PILLOW_SIDE_HAPPY_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.ROLL_ON_BED, null )
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.AWAKE_PILLOW_SIDE_YAWN_LONG_RIGHT,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 0.5f, 0.3f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.05f, (int)Companion.AnimationEventName.SPEAK, new float[]{(float)Companion.VoiceLine.YAWN_LONG,1.0f} ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.AWAKE_PILLOW_SIDE_TO_SLEEP_PILLOW_SIDE_RIGHT,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 0.5f, 0.3f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.05f, (int)Companion.AnimationEventName.SPEAK, new float[]{(float)Companion.VoiceLine.MISC_IDLE,0.0f} ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.AWAKE_PILLOW_SIDE_SOUND_GOODNIGHT_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.05f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.GOODNIGHT, 1.0f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.SLEEP_PILLOW_SIDE_IDLE_RIGHT,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 0.5f, 0.3f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.5f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.SLEEP_BREATHING, 1.0f } )
                },
                AnimationInfo.Flag.IDLE_STATE
            ), true);
            ...
            RegisterAnimation(Companion.Animation.SLEEP_PILLOW_SIDE_TO_SLEEP_PILLOW_UP_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.SLEEP_DISTURBED_LONG, 0.0f } ),
                new( 0.0f, (int)Companion.AnimationEventName.ROLL_ON_BED, null )
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.SLEEP_PILLOW_SIDE_HEADPAT_START_RIGHT,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 0.5f, 0.3f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.4f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.HEADPAT_RETURN, 1.0f } )
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.SLEEP_PILLOW_UP_TO_AWAKE_HAPPY_PILLOW_UP,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 0.5f, 0.3f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.YAWN_SHORT, 1.0f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.55f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 0.65f, 0.5f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.SLEEP_PILLOW_UP_TO_AWAKE_ANGRY_PILLOW_UP,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 0.5f, 0.3f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 1.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_POUT, 0.0f } ),
                new( 0.55f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 0.65f, 0.5f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.SLEEP_PILLOW_SIDE_TO_AWAKE_HAPPY_PILLOW_UP_RIGHT,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 0.5f, 0.3f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.03f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 1.0f } ),
                new( 0.3f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.TROUBLED, 1.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.ROLL_ON_BED, null ),
                new( 0.4f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 0.65f, 0.5f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.AWAKE_HAPPY_PILLOW_UP_HEADPAT_LOOP,
                ...
                new CompanionAnimationEvent[]{
                new( 0.45f, (int)Companion.AnimationEventName.HEADPAT_PROPER_SOUND, null )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_TO_CRAWL,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.4f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EFFORT, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.AWAKE_PILLOW_UP_TO_CRAWL_TIRED,
                ...
                new CompanionAnimationEvent[]{
                new( 0.4f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EFFORT, 0.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.JUMP_ON_BED, null ),
                new( 0.95f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.CRAWL_BED_TO_STAND,
                ...
                new CompanionAnimationEvent[]{
                new( 0.4f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EFFORT, 0.0f } ),
                new( 0.2f, (int)Companion.AnimationEventName.ROLL_ON_BED, null ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 0.65f, 0.5f } ),
                },
                AnimationInfo.Flag.DISABLE_RAGDOLL_CHECK
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_SOUND_GOOD_MORNING,
                ...
                new CompanionAnimationEvent[]{
                new( 0.05f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.GOODMORNING, 1.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_GIDDY_SURPRISE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.080f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.IMPRESSED_VERY, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_SEARCH_RIGHT,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 1.0f, 0.4f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.DISAPPOINTED_STARTLE, 1.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.TROUBLED, 1.0f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 1.0f } )
                },
                AnimationInfo.Flag.IDLE_STATE
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_TO_SIT_FLOOR,
                ...
                new CompanionAnimationEvent[]{
                new( 0.6f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 0.8f } ),
                new( 0.6f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_OUTFIT_LIKE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.2f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.IMPRESSED_VERY, 1.0f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.5f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.6f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HANDHOLD_ANGRY_REFUSE_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_SHORT, 0.0f } ),
                new( 0.78f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 0.5f, 1.0f } ),
                new( 0.78f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                new( 0.65f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_GRUMBLE_SHORT, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HANDHOLD_HAPPY_EMBARRASSED_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EMBARRASSED_HANDHOLD, 1.0f } ),

                new( 0.075f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.5f } ),
                new( 0.075f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.6f } ),

                new( 0.655f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.5f, 0.6f } ),
                new( 0.655f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.5f } ),

                new( 0.735f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.6f } ),
                new( 0.735f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.5f } ),

                new( 0.88f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.5f, 0.6f } ),
                new( 0.88f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.5f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_HEADPAT_BRUSH_AWAY,
                ...
                0.2f, new Companion.AnimLogicInfo(0, 1.0f, 0.3f, 0, 0.3f),
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_LONG, 1.0f } ),
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_HEADPAT_ANGRY_IDLE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_POUT, 1.0f } ),
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_HEADPAT_HAPPY_IDLE,
                ...
                0.3f, new Companion.AnimLogicInfo(3, 1.0f, 0.5f, 12, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.05f, (int)Companion.AnimationEventName.HEADPAT_PROPER_SOUND, null ),
                new( 0.45f, (int)Companion.AnimationEventName.HEADPAT_PROPER_SOUND, null ),
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_HEADAPAT_ANGRY_PROPER_TO_HAPPY,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 1.0f, 0.5f, 0, 0.3f),
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_HEADPAT_B, 1.0f } ),
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_ON_KNEES_HEADPAT_BRUSH_AWAY_TO_ANGRY_IDLE,
                ...
                0.2f, new Companion.AnimLogicInfo(0, 1.0f, 0.3f, 0, 0.3f),
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_LONG, 0.0f } ),
                new( 0.2f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_KERPLUNK } ),
                new( 0.0f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_MOVEMENT } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HEADPAT_HAPPY_START,
                ...
                new CompanionAnimationEvent[]{
                new( 0.05f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.DISAPPOINTED_STARTLE, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HEADPAT_HAPPY_AFTER_MORE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.HEADPAT_RETURN, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HEADPAT_HAPPY_IDLE_SAD_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.WHINE_SOFT, 0.0f } ),
                new( 0.34f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.6f } ),
                new( 0.34f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.3f } ),
                new( 0.85f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.3f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_HEADPAT_HAPPY_SATISFACTION,
                ...
                0.3f, new Companion.AnimLogicInfo(0, 1.0f, 0.5f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ECSTATIC, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HEADPAT_ANGRY_LOOP,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_POUT, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HEADPAT_ANGRY_END,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_GRUMBLE_LONG, 0.0f } ),
                new( 0.46f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 1.1f } ),
                new( 0.76f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.7f } ),
                new( 0.76f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 1.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HEADPAT_CLIMAX_TO_CANCEL_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_LONG, 0.0f } ),
                new( 0.4f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 1.0f } )
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_HEADPAT_CLIMAX_TO_HAPPY,
                ...
                0.3f, null,
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_HEADPAT_B, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_HEADPAT_INTERRUPT,
                ...
                0.2f, new Companion.AnimLogicInfo(0, 1.0f, 0.5f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.HUMPH, 0.0f } )
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_FACE_PROX_ANGRY_LOOP,
                ...
                new CompanionAnimationEvent[]{
                new( 0.112f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_GRUMBLE_SHORT, 0.0f } ),
                new( 0.412f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_GRUMBLE_LONG, 0.0f } ),
                new( 0.837f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_GRUMBLE_LONG, 0.0f } )
                },
                AnimationInfo.Flag.IDLE_STATE
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_KISS_ANGRY_CHEEK_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.112f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.KISSED_ANGRY, 1.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_KISS_ANGRY_LEFT_TO_HAPPY,
                ...
                new CompanionAnimationEvent[]{
                new( 0.16f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.3f } ),
                new( 0.16f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.3f, 0.5f } ),
                new( 0.26f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.3f } ),
                new( 0.35f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.3f } ),
                new( 0.35f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.5f } ),
                new( 0.55f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.3f } ),
                new( 0.52f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.5f } ),
                new( 0.80f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.3f } ),
                new( 0.80f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.7f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.RELIEF, 1.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_FACE_PROX_HAPPY_LOOP,
                ...
                0.25f, new Companion.AnimLogicInfo(1, 0.6f, 0.5f, 12, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.075f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EMBARRASSED, 1.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                },
                AnimationInfo.Flag.IDLE_STATE
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_KISS_HAPPY_CHEEK_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.KISSED_HAPPY, 1.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_KISS_ANGRY_LEFT_TO_ANGRY,
                ...
                new CompanionAnimationEvent[]{
                new( 0.112f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_SHORT, 1.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_TIRED_LOCOMOTION,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.BIND_ANIMATION_TO_VIEW_MODE, new float[]{ (float)Companion.AwarenessMode.TIRED } ),
            ...
            RegisterAnimation(Companion.Animation.STAND_TO_STAND_TIRED,
                ...
                new CompanionAnimationEvent[]{
                new( 0.05f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.YAWN_LONG, 1.0f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3, 0.5f, 0.8f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_TIRED_RUB_EYES_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.4f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.YAWN_SHORT, 1.0f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3, 0.5f, 0.8f } ),
                },
                AnimationInfo.Flag.IDLE_STATE
            ));
            ...
            PokeBehavior.TransitionToPostFacePokeAnim postFacePokeAnimTransition = new();
            RegisterAnimation(Companion.Animation.BATHTUB_RELAX_FACE_POKE_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.STARTLE_SHORT, 0.0f } ),
                new( 0.4f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 0.5f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_TIRED_POKE_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.4f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.WHIMPER_SHORT, 0.0f } ),
                new( 0.4f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 1.5f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.SLEEP_PILLOW_SIDE_BOTHER_RIGHT,
                ...
                0.1f, new Companion.AnimLogicInfo(0, 0.5f, 0.3f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.SNORE, 0.0f } )
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_POKE_FACE_1_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.STARTLE_SHORT, 0.0f } ),
                new( 0.4f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.5f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_POKE_FACE_2_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.STARTLE_SHORT, 0.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.7f} ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_WIPE_CHEEK_RIGHT,
                ...
                0.2f, new Companion.AnimLogicInfo(0, 1.0f, 0.3f, 0, 0.3f),
                new CompanionAnimationEvent[]{
                new( 0.45f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                new( 0.45f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.4f} ),
                new( 0.45f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_GRUMBLE_SHORT, 0.0f } ),
                new( 0.71f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_HEADPAT_A, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_ANGRY_BLOCK_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.ANGRY_LONG, 0.0f } ),
                new( 0.3f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.8f } ),
                new( 0.3f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 1.0f} ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_POKED_TUMMY_OUT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.2f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                new( 0.2f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 1.8f } ),
                new( 0.68f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.RELIEF, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.STAND_WHEAT_INTO_MORTAR_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.5f, (int)Companion.AnimationEventName.DROP_LEFT_HAND_ITEM, null ),
                },
                AnimationInfo.Flag.DISABLE_HOLDIK_BOTH
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_SPLASHED_END_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.781f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 1.0f } ),
                new( 0.781f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_SPLASH_REACT_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.STARTLE_SHORT, 0.0f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 1.0f, 0.7f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.BATHTUB_HAPPY_SPLASH,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.LAUGH_SHORT, 1.0f } ),
                new( 0.3f, (int)Companion.AnimationEventName.BATHTUB_PLAY_SOUND, new float[]{ (float)Bathtub.SoundType.WATER_SPLASH } ),
                new( 0.3f, (int)Companion.AnimationEventName.BATHTUB_SPLASH, null ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_HEADPAT_HAPPY_WANTED_MORE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.DISAPPOINTED_STARTLE, 0.0f } ),
                new( 0.35f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.DISAPPOINTED_SIGH, 0.0f } ),
                new( 0.3f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.8f } ),
                new( 0.3f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 0.0f, 0.3f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.8f } ),
                new( 0.9f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.3f } ),
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_REFUSE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.REFUSE, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_REACH_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 0.8f, 0.7f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.5f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_PLACE_CARD_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.EFFORT, 0.0f } ),
                new( 0.4f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 1.0f, 0.8f, 0.5f } ),
                new( 0.4f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.5f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.FLOOR_SIT_PICK_CARD_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.BLEND_CONTROLLER_RIGHT, new float[]{ 0.0f } ),
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.EXECUTE_PICK_CARD_RIGHT, null ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_IMPRESSED1,
                ...
                0.3f, new Companion.AnimLogicInfo(1, 0.8f, 0.2f, 12, 0.3f),
                new CompanionAnimationEvent[]{
                new( 0.0f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.IMPRESSED_VERY, 1.0f } ),
                new( 0.2f, (int)Companion.AnimationEventName.PLAY_CLAP_SOUND, null ),
                new( 0.26f, (int)Companion.AnimationEventName.PLAY_CLAP_SOUND, null ),
                new( 0.34f, (int)Companion.AnimationEventName.PLAY_CLAP_SOUND, null ),
                new( 0.42f, (int)Companion.AnimationEventName.PLAY_CLAP_SOUND, null ),
                new( 0.50f, (int)Companion.AnimationEventName.PLAY_CLAP_SOUND, null ),
                new( 0.58f, (int)Companion.AnimationEventName.PLAY_CLAP_SOUND, null ),
                new( 0.66f, (int)Companion.AnimationEventName.PLAY_CLAP_SOUND, null ),
                new( 0.74f, (int)Companion.AnimationEventName.PLAY_CLAP_SOUND, null ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_FACE_DOWN_TO_STAND,
                ...
                new CompanionAnimationEvent[]{
                new( 0.2f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.8f, 0.5f } ),
                new( 0.8f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.5f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.FLOOR_FACE_SIDE_TO_STAND_RIGHT,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.85f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 0.8f, 0.5f } ),
                new( 0.85f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.5f } ),
                }
            ), true);
            ...
            RegisterAnimation(Companion.Animation.STAND_MERCHANT_IDLE1,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 0.0f, 1.0f, 0.5f } ),
                new( 0.5f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.5f } ),
                new( 1.0f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.5f } ),
                new( 1.0f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 7.0f, 0.5f } ),
                }
            ));
            RegisterAnimation(Companion.Animation.STAND_BOW,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.MISC_IDLE, 0.0f } ),
                new( 0.7f, (int)Companion.AnimationEventName.SET_BODY_FLAGS, new float[]{ 3.0f, 1.0f, 0.4f } ),
                new( 0.6f, (int)Companion.AnimationEventName.SET_EYE_FLAGS, new float[]{ 12.0f, 0.4f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.SQUAT_TO_RELAX,
                ...
                0.3f, new Companion.AnimLogicInfo(1, 0.3f, 0.3f, 0, 0.4f),
                new CompanionAnimationEvent[]{
                new( 0.3f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.RELIEF, 0.0f } ),
                }
            ));
            ...
            RegisterAnimation(Companion.Animation.RELAX_TO_SQUAT_STARTLE,
                ...
                new CompanionAnimationEvent[]{
                new( 0.1f, (int)Companion.AnimationEventName.SPEAK, new float[]{ (float)Companion.VoiceLine.SCARED_SHORT, 0.0f } ),
                }
            ));
