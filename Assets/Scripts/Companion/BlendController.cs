...
namespace Viva
{
    ...
    public class BlendController
    {
        ...
        public readonly Companion.ArmIK.RetargetingInfo retargetingInfo = new();
        public Companion.Animation targetAnimation;
        private readonly Tools.EaseBlend boundaryEase = new();
        private readonly OnIKControl controlCallback;
        private CompanionHandState.HoldBlendMax holdBlendMax = new();
