...
namespace Viva
{
    ...
    public partial class HeadpatBehavior : PassiveBehaviors.PassiveTask
    {
        ...
        private Companion.ArmIK.RetargetingInfo spineInfo = new();
        private Tools.EaseBlend headpatBlend = new();
        ...
        private Vector3 headpatSpine3EulerOffset = new(-90.0f, 180.0f, 0.0f);
        private Vector3 headpatNeckEulerOffset = new(120.0f, 0.0f, 0.0f);
