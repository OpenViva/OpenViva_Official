...
namespace Viva
{
    ...
    public partial class Companion : Character
    {
        ...
        private Set<ViewItem> viewItems = new();
        private List<Item> inViewButBlocked = new();
        ...
        private Vector3 lookAtHeadOffset = new(0.0f, -0.05f, 0.0f);
        ...
        public class LookAtBone
        {
            ...
            private Quaternion cachedQuaternion = new();
            public Tools.EaseBlend easeBlend = new();
