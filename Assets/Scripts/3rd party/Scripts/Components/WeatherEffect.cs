...
namespace OccaSoftware.Altos.Runtime
{
    ...
    public class WeatherEffect : MonoBehaviour
    {
        ...
        public CameraFollowSettings cameraFollowSettings = new();
        ...
        public class CameraFollowSettings
        {
            ...
            public Vector3 positionOffset = new(0, 5, 0);
        }

        [Header("Precipitation Options")]
        public WeathermapIntegrationSettings weathermapIntegrationSettings = new();
        public PrecipitationCollisionSettings precipitationCollisionSettings = new();

        [Header("Temperature Options")]
        public TemperatureIntegrationSettings temperatureIntegrationSettings = new();

        [Header("Wind Zone Options")]
        public WindZoneIntegrationSettings windZoneIntegrationSettings = new();

        [Header("Origin Management Options")]
        public OriginManagementSettings originManagementSettings = new();

        [Header("Time of Day Options")]
        public DaytimeFactorSettings daytimeFactorSettings = new();
