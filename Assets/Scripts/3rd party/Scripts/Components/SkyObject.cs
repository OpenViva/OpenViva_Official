...
namespace OccaSoftware.Altos.Runtime
{
    ...
    public class SkyObject : MonoBehaviour
    {
        ...
        public AnimationCurve colorTemperatureCurve = new(
            new Keyframe[] { new(0, 2000), new(0.45f, 2000), new(1f, 6500) }
        );
        ...
        public AnimationCurve intensityCurve = new(
            new Keyframe[] { new(0, 0), new(0.45f, 0f), new(0.5f, 1f), new(1f, 1.5f) }
        );
        ...
        */
        ...
        {
            Vector3 center = new(0, 0, sortOrder * Mathf.Sin(Mathf.Deg2Rad * inclinationOffset));
