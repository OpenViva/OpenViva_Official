...
namespace OccaSoftware.Altos.Runtime
{
    ...
    public class SkyDefinition : ScriptableObject
    {
        ...
        /// </summary>
        public List<PeriodOfDay> periodsOfDay = new();
        ...
        private static readonly Vector3 RGB_LUMINANCE = new(0.2126f, 0.7152f, 0.0722f);
        ...
        private Color Saturation(Color color, float saturation)
        {
            ...
            Vector3 c = new(color.r, color.g, color.b);
