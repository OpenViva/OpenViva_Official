    ...
    public class Bag : Item
    {
        ...
        public class BagItemCategory
        {
            ...
            public void RenderIcon(RenderTexture renderTexture)
            {
                ...
                Texture2D newIcon = new(renderTexture.width, renderTexture.height, TextureFormat.RGBA32, false, true);
        ...
        private TransformBlend handWearBlend = new();
        ...
        private List<BagItemCategory> m_storedItems = new();
        ...
        public override void Save(GameDirector.VivaFile vivaFile)
        {
            ...
            List<VivaSessionAsset> tempManifestList = new();
        ...
        private void SetUIFacingOwner()
        {
            ...
            Vector3 uiSide = new(0.125f, 0.0f, 0.0f);
