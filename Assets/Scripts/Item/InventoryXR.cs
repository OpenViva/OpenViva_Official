...
//        _player.Controls.Viva.InteractLeft.performed += TakeSelectedItemLeft;
//        _player.Controls.Viva.InteractRight.performed += TakeSelectedItemRight;
//    }
...
//    private void TakeSelectedItemLeft(InputAction.CallbackContext context)
//    {
//        Take(2);
//    }

//    private void TakeSelectedItemRight(InputAction.CallbackContext context)
//    {
//        Take(1);
//    }
...
//            PlayerKB_GrabObject itemScript = item.GetComponent<PlayerKB_GrabObject>();
//            itemScript.SetIsActive(true, handedness);
//            _numElements--;
