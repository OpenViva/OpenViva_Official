...
namespace Viva
{
    ...
    public class ItemSettings : ScriptableObject
    {
        ...
        [SerializeField]
        private Vector3 m_IKHoldTarget = new(0.12f, 0.06f, 0.17f);
        public Vector3 IKTarget { get { return m_IKHoldTarget; } }
        [SerializeField]
        private Vector3 m_IKHoldPole = new(0.18f, 0.06f, -0.45f);
        public Vector3 IKPole { get { return m_IKHoldPole; } }
        [SerializeField]
        private Vector3 m_IKHoldEuler = new(177.28f, -99.4f, -61.8f);
        ...
        [SerializeField]
        private Vector3 m_holdRotationOffset = new(0, 0, 0);
