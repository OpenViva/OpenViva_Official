...
namespace Viva
{
    ...
    public partial class Steganography : MonoBehaviour
    {
        ...
        {
            Texture2D card = new(PACK_SIZE, CARD_HEIGHT, TextureFormat.RGB24, false, true);
            card.name = name;
        ...
        public static Texture2D AttemptSaveCardThumbnail(Texture2D target, string folder)
        {
            ...
            Texture2D thumbnail = new(thumbnailWidth, thumbnailHeight, TextureFormat.RGB24, false, false);
