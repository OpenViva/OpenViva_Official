...
namespace Viva
{
    public class AmbienceDirector : MonoBehaviour
    {
        [HideInInspector]
        [SerializeField]
        private List<AudioSource> windowSourcesA = new();
        private List<AudioSource> windowSourcesB = new();

        [HideInInspector]
        [SerializeField]
        private List<AudioSource> daytimeOnlySources = new();
        [HideInInspector]
        [SerializeField]
        private List<AudioSource> nighttimeOnlySources = new();
        ...
        [SerializeField]
        private List<AudioSource> globalAmbienceSourcesA = new();
        [SerializeField]
        private List<AudioSource> globalAmbienceSourcesB = new();
