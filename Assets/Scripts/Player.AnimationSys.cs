...
namespace Viva
{
    ...
    public partial class Player : Character
    {
        ...
        private Tools.EaseBlend vrAnimatorBlend = new();
        private Vector3 vrAnimationPosOffset = Vector3.zero;
        private Tools.EaseBlend vrAnimatorBlendAllowHands = new();
        private PlayerAnimationEvent.Context animationEventContext;
        private Dictionary<Animation, PlayerAnimationInfo> m_animationInfos = new();
        ...
        private void InitAnimations()
        {
            ...
            m_animationInfos[Animation.GESTURE_COME] = new PlayerAnimationInfo(Animator.StringToHash("player_gesture_come"), duration, Priority.LOW, Animation.IDLE, 1.0f,
                ...
                new( 0.5f ,(int)AnimationEventName.FIRE_GESTURE, new float[]{ 1, (int)Gesture.FOLLOW } )
                }
            );
            m_animationInfos[Animation.GESTURE_STOP] = new PlayerAnimationInfo(Animator.StringToHash("player_gesture_stop"), duration, Priority.LOW, Animation.IDLE, 1.0f,
                new PlayerAnimationEvent[]{
                new( 0.5f ,(int)AnimationEventName.FIRE_GESTURE, new float[]{ 1, (int)Gesture.STOP } )
                }
            );
            m_animationInfos[Animation.GESTURE_WAVE] = new PlayerAnimationInfo(Animator.StringToHash("player_gesture_wave"), duration, Priority.LOW, Animation.IDLE, 1.0f,
                new PlayerAnimationEvent[]{
                new( 0.5f ,(int)AnimationEventName.FIRE_GESTURE, new float[]{ 1, (int)Gesture.HELLO } )
                }
            );
            m_animationInfos[Animation.GESTURE_PRESENT_RIGHT] = new PlayerAnimationInfo(Animator.StringToHash("player_gesture_present"), duration, Priority.LOW, Animation.GESTURE_PRESENT_RIGHT, 0.0f,
                new PlayerAnimationEvent[]{
                new( 1.0f ,(int)AnimationEventName.FIRE_GESTURE, new float[]{ 1, (int)Gesture.PRESENT_START } )
                }
            );
            m_animationInfos[Animation.GESTURE_PRESENT_LEFT] = new PlayerAnimationInfo(Animator.StringToHash("player_gesture_present"), duration, Priority.LOW, Animation.GESTURE_PRESENT_LEFT, 0.0f,
                new PlayerAnimationEvent[]{
                new( 1.0f ,(int)AnimationEventName.FIRE_GESTURE, new float[]{ 0, (int)Gesture.PRESENT_START } )
                }
            );
            ...
            new PlayerAnimationEvent[]{
            new( 0.5f, (int)AnimationEventName.ADD_CARD_TO_RIGHT_HAND, null )
            });
            ...
            new PlayerAnimationEvent[]{
            new( 0.5f, (int)AnimationEventName.ADD_CARD_TO_LEFT_HAND, null )
            });
            ...
            m_animationInfos[Animation.BAG_PLACE_INSIDE_RIGHT] = new PlayerAnimationInfo(
                ...
                new PlayerAnimationEvent[]{
                new( 0.0f, (int)AnimationEventName.OPEN_BAG, new float[]{ 1.0f } ),
                new( 0.5f ,(int)AnimationEventName.STORE_ITEM_IN_BAG, new float[]{ 1.0f } )
                }
            );
            m_animationInfos[Animation.BAG_PLACE_INSIDE_LEFT] = new PlayerAnimationInfo(
                ...
                new PlayerAnimationEvent[]{
                new( 0.0f, (int)AnimationEventName.OPEN_BAG, new float[]{ 0.0f } ),
                new( 0.5f ,(int)AnimationEventName.STORE_ITEM_IN_BAG, new float[]{ 0.0f } )
                }
            );
            m_animationInfos[Animation.BAG_TAKE_OUT_RIGHT] = new PlayerAnimationInfo(
                ...
                new PlayerAnimationEvent[]{
                new( 0.0f, (int)AnimationEventName.OPEN_BAG, new float[]{ 1.0f } ),
                new( 0.5f ,(int)AnimationEventName.TAKE_OUT_OF_BAG, new float[]{ 1.0f } )
                }
            );
            m_animationInfos[Animation.BAG_TAKE_OUT_LEFT] = new PlayerAnimationInfo(
                ...
                new PlayerAnimationEvent[]{
                new( 0.0f, (int)AnimationEventName.OPEN_BAG, new float[]{ 0.0f } ),
                new( 0.5f ,(int)AnimationEventName.TAKE_OUT_OF_BAG, new float[]{ 0.0f } )
                }
            );
