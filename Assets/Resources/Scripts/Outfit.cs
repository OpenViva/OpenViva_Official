...
namespace Viva
{
    ...
    public class Outfit : SerializedTaskData
    {
        ...
        [SerializeField]
        private List<ClothingPreset> clothingPieces = new();
        public Dictionary<ClothingPreset, Outfit.ClothingOverride> clothingOverrides = new();
        public Color fingerNailColor = new(1.0f, 0.76f, 0.74f);
        public Color toeNailColor = new(1.0f, 0.62f, 0.58f);
