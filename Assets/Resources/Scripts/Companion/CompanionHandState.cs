...
namespace Viva
{
    ...
    public class CompanionHandState : HandState
    {
        ...
        public readonly Companion.ArmIK.RetargetingInfo holdRetargeting = new();
        ...
        private Tools.EaseBlend cacheIKEaseBlend = new();
        [SerializeField]
        ...
        private Set<HoldBlendMax> holdBlendMaxes = new();
        private float[] animationHoldBlendMap;
        private HoldBlendMax animationHoldBlendMax = new();
