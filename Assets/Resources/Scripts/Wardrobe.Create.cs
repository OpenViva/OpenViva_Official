    ...
    public partial class Wardrobe : UITabMenu
    {
        ...
        private void OnUpdateCreateCardPage(int page)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                Vector3 position = new((-1.0f + i % 3) * 170, (0.5f - i / 3) * 205);
        ...
        private IEnumerator OnDropTextureFile(Companion companion, string filepath, Image dragFileImage)
        {
            ...
            ModelCustomizer.FileTextureRequest request = new(
                filepath,
                new Vector2Int[] { new(Steganography.PACK_SIZE, Steganography.PACK_SIZE) },
            ...
            {   //zoom towards selected clothing preset button
                ...
                Outfit.ClothingOverride clothingOverride = new(request.result, request.result.name);
                ...
                GameDirector.PhotoshootRequest photoshoot = new(
                ...
                Steganography.PackLossyTextureRequest packRequest = new(
