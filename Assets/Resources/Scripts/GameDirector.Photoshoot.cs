...
namespace Viva
{
    ...
    public partial class GameDirector : MonoBehaviour
    {
        ...
        {
            RenderTexture renderTexture = new(resolution.x, resolution.y, 16, RenderTextureFormat.ARGB32, RenderTextureReadWrite.sRGB);
            ...
            Texture2D newTexture = new(Steganography.PACK_SIZE, Steganography.CARD_HEIGHT, TextureFormat.RGB24, false, true);
