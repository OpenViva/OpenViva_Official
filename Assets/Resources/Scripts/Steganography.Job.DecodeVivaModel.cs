...
namespace Viva
{
    ...
    public partial class Steganography : MonoBehaviour
    {
        ...
        {
            NativeArray<byte> nativeByteArray = new(byteArray.Length, allocator, NativeArrayOptions.UninitializedMemory);
        ...
        public struct DecodeVivaModelJob : IJob
        {
            ...
            private void ReadInfo(ByteStreamReader bsr)
            {
                ...
                for (int i = 0; i < infoSphereCount; i++)
                {
                    ...
                    Vector4 info = new(bsr.ReadFloat(), bsr.ReadFloat(), bsr.ReadFloat(), bsr.ReadFloat());
                    if (infoName == "headpat")
                    {
            ...
            public void Execute()
            {
                ...
                ByteStreamReader bsr = new(rawData);
