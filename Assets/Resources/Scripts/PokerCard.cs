...
namespace Viva
{
    ...
    public class PokerCard : Item
    {
        ...
        private static readonly Vector2 numberQuadTLUV = new(0.6338f, 0.5f);
        private static readonly Vector2 numberQuadSize = new(0.0732f, -0.0732f);
        private static readonly Vector2 suitQuadTLUV = new(0.7556f, 0.7197f);
        private static readonly Vector2 suitQuadSize = new(0.1221f, -0.1401f);
        private static readonly Vector2 royaltyQuadTopLeftUV = new(0.0f, 0.0f);
        private static readonly Vector2 royaltyQuadSize = new(0.318f, -0.4990f);
        ...
        private List<PokerCard> fanGroupChildren = new();
        private List<Util.Tuple<int, TransformBlend>> newCardParentingBlends = new();
        ...
        protected static Dictionary<int, PokerCard[]> decks = new();
        ...
        private void UpdateThickness()
        {
            ...
            Vector3 newScale = new(1.0f, cardSize, 1.0f);
        ...
        private bool UpdateParentingBlend(Util.Tuple<int, TransformBlend> parentingBlend)
        {
            ...
            Vector3 pivot = new(0.0f, 0.0f, -0.1f);
        ...
        private void CheckPlayerVRPickCard()
        {
            ...
            Ray ray = new(fingerTip, otherHandState.fingerAnimator.hand.right);
        ...
        private PokerCard FindNearestRadianFanCard(Ray ray, float minimumSqDist, float maxRayDist)
        {
            ...
            Plane fanPlane = new(transform.up, transform.position);
