...
namespace Viva.Util
{
    ...
    public class CountedSet<T>
    {
        ...
        private readonly List<int> objectCounts = new();
    ...
    public class TransformBlend
    {
        ...
        public readonly Tools.EaseBlend blend = new();
    ...
    public static partial class Tools
    {
        ...
        public static Mesh CreateQuad(float width = 1f, float height = 1f)
        {
            ...
            Vector3[] verts = new Vector3[4] { new(w, -h, 0), new(-w, -h, 0), new(w, h, 0), new(-w, h, 0) };
            ...
            Vector2[] uvs = new Vector2[4] { new(0, 0), new(1, 0), new(0, 1), new(1, 1), };
        ...
        public static Texture2D CreateThumbnailTexture(string stringData, int resolution, TextureFormat format, bool mipMap)
        {
            ...
            Texture2D thumbnailTex = new(resolution, resolution, format, mipMap, true);
            try
            {
