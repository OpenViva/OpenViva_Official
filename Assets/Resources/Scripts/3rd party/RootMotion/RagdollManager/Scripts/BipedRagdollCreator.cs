...
namespace RootMotion.Dynamics {
	...
	public class BipedRagdollCreator : RagdollCreator {
		...
		private static void CreateJoints(BipedRagdollReferences r, Options o) {
			...
			// Arms
			CreateJointParams.Limits upperArmLimits = new(-35f * o.jointRange, 120f * o.jointRange, 85f * o.jointRange, 45 * o.jointRange);
			CreateJointParams.Limits lowerArmLimits = new(0f, 140f * o.jointRange, 10f * o.jointRange, 45f * o.jointRange);
			CreateJointParams.Limits handLimits = new(-50f * o.jointRange, 50f * o.jointRange, 50f * o.jointRange, 25f * o.jointRange);
			...
			// Legs
			CreateJointParams.Limits upperLegLimits = new(-120f * o.jointRange, 35f * o.jointRange, 85f * o.jointRange, 45 * o.jointRange);
			CreateJointParams.Limits lowerLegLimits = new(0f, 140f * o.jointRange, 10f * o.jointRange, 45f * o.jointRange);
			CreateJointParams.Limits footLimits = new(-50f * o.jointRange, 50f * o.jointRange, 50f * o.jointRange, 25f * o.jointRange);
