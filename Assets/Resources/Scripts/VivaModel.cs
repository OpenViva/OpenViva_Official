...
namespace Viva
{
    ...
    public partial class VivaModel
    {
        ...
        public static IEnumerator DeserializeVivaModel(CreateCompanionRequest request)
        {
            ...
            VivaModel model = new(request.sourceCardFilename, request.companionName);
            ...
            ByteStreamReader bsr = new(model.modelData);
        ...
        public List<DynamicBoneInfo> dynamicBoneInfos = new();
        ...
        {
            List<Transform> potentialDynamicBoneRoots = new();
        ...
        {
            Material newMaterial = new(GameDirector.instance.vivaModelMaterial);
        ...
        public byte[] SerializeToCardData()
        {
            ...
            foreach (DynamicBoneInfo info in dynamicBoneInfos)
            {
                ...
                List<bool> dynamicBoneBooleans = new()
                {
