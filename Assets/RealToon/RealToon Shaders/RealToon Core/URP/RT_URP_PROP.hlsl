...
CBUFFER_START(UnityPerMaterial)
	...
	//== Others
		...
		uniform half _UseSkin;
		uniform half4 _SkinColor;
		uniform half4 _FingerNailColor;
		uniform half4 _ToeNailColor;

		uniform half _PupilShrink;
		uniform half _PupilRight;
		uniform half _SideMultiplier;
...
UNITY_DOTS_INSTANCING_START(MaterialPropertyMetadata)
	...
	UNITY_DOTS_INSTANCED_PROP(float, _UseSkin)
	UNITY_DOTS_INSTANCED_PROP(float4, _SkinColor)
	UNITY_DOTS_INSTANCED_PROP(float4, _FingerNailColor)
	UNITY_DOTS_INSTANCED_PROP(float4, _ToeNailColor)
	UNITY_DOTS_INSTANCED_PROP(float, _PupilShrink)
	UNITY_DOTS_INSTANCED_PROP(float, _PupilRight)
	UNITY_DOTS_INSTANCED_PROP(float, _SideMultiplier)
	UNITY_DOTS_INSTANCED_PROP(float, _PupilUp)
...
#define _UseSkin										UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _UseSkin)
#define _SkinColor										UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4, _SkinColor)
#define _FingerNailColor								UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4, _FingerNailColor)
#define _ToeNailColor									UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float4, _ToeNailColor)
#define _PupilShrink									UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _PupilShrink)
#define _PupilRight										UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _PupilRight)
#define _SideMultiplier									UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _SideMultiplier)
#define _PupilUp										UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float, _PupilUp)
