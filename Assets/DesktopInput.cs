...
//     version 1.14.2
//     from Assets/DesktopInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/DesktopInput.inputactions".
/// </summary>
/// <remarks>
...
public partial class @DesktopInput: IInputActionCollection2, IDisposable
{
    ...
    ~@DesktopInput()
    {
        UnityEngine.Debug.Assert(!m_Viva.enabled, "This will cause a leak and performance issues, DesktopInput.Viva.Disable() has not been called.");
    }
    ...
    public struct VivaActions
    {
        ...
        /// </summary>
        public VivaActions(@DesktopInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
