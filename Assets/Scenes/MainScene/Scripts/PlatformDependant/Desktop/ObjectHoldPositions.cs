...
{
    private Vector3[] allObjectPositionsLeft = new Vector3[10]
    {
    ...
    private Vector3[] allObjectPositionsRight = new Vector3[10]
    {
    ...
    private Quaternion[] allObjectRotationsLeft = new Quaternion[10]
    {
    ...
    private Quaternion[] allObjectRotationsRight = new Quaternion[10]
    {
        Quaternion.Euler(0f, -90f, 0f), // BAG
