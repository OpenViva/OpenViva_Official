...
{
    private Vector3[] allObjectPositionsLeft = new Vector3[7]
    {
    ...
    private Vector3[] allObjectPositionsRight = new Vector3[7]
    {
    ...
    private Quaternion[] allObjectRotationsLeft = new Quaternion[7]
    {
    ...
    private Quaternion[] allObjectRotationsRight = new Quaternion[7]
    {
        Quaternion.Euler(0f, -90f, 0f), // BAG
