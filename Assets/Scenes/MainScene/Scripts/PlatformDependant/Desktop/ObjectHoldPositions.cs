...
{
    private Vector3[] allObjectPositionsLeft = new Vector3[13]
    {
    ...
    private Vector3[] allObjectPositionsRight = new Vector3[13]
    {
    ...
    private Quaternion[] allObjectRotationsLeft = new Quaternion[13]
    {
    ...
    private Quaternion[] allObjectRotationsRight = new Quaternion[13]
    {
        Quaternion.Euler(0f, -90f, 0f), // BAG
